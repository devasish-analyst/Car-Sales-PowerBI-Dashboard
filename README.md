...
- Identify trends, growth opportunities, and regional performance
...
- **YTD Total Sales by Body Style**  
  Pie chart representing sales distribution by car body style.

- **YTD Total Sales by Color**  
  Pie chart displaying sales contribution by car color.

- **YTD Cars Sold by Dealer Region**  
  Map chart visualizing geographical sales distribution.

- **Company-wise Sales Trend (Grid View)**  
  Tabular view showing company names and their YTD sales.
...
- KPI cards
- Line charts, pie charts, map visuals
- Slicers for dynamic filtering
- Drill-through and interactive tables
...
- Regional analysis reveals high-performing dealer locations
